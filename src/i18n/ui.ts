...
export const ui = {
  en: {
    ...
    'home.presentation2': 'I consider myself agnostic to the technology, with a generalist perspective. I am full-stack developer, specialized in Javascript, with a slight inclination towards front-end. I love Docker (DevOps is not my passion). I am good at using Figma... but probably not the best designer. Where I perform best is having an holistic vision of the software we are building, coordinating people, technology, and business.',
