...
Probably you know that [SOL](https://coinmarketcap.com/es/currencies/solana/ "SOL Cryptocurrency") is the native token in this blockchain. SOL is using to pay the transactions and
taxes in the network. But probably you do not know that is called Lamport (as recognition to [Leslie Lamport](https://es.wikipedia.org/wiki/Leslie_Lamport "Leslie Lamport")) to
...
you need SOL to develop or test any smart contract, either on devnet or testnet, you can use a [Solana faucet](https://solfaucet.com/ "Solana faucet").
...
its official [Explorer](https://explorer.solana.com/ "Solana Explorer"), or also we can find another one like [Solscan](https://solscan.io/ "Solscan") with few differences in the information that shows us.
...
Solana has [a long list of RPC methods](https://docs.solana.com/es/api/http "List of RPC methods") we can use to communicate with the blockchain, to get a wallet balance, send a
...
- [@solana/web3.js](https://www.npmjs.com/package/@solana/web3.js "@solana/web3.js"): main dependency that integrates all RPC methods to communicate with Solana.
- [@project-serum/anchor](https://www.npmjs.com/package/@project-serum/anchor "@project-serum/anchor"): client to communicate with smart contract developed with Anchor. [Anchor](https://www.anchor-lang.com/ "Anchor") is a Rust-based framework to build contracts in Solana.
- [@solana/spl-token](https://www.npmjs.com/package/@solana/spl-token "@solana/spl-token"): dependency to interact with tokens and NFTs.
- [@metaplex-foundation/js](https://www.npmjs.com/package/@metaplex-foundation/js "@metaplex-foundation/js"): another dependency that will be important to work with tokens in Solana.
...
---
Post created in collaboration with the **Solana Course** from **Platzi**.
