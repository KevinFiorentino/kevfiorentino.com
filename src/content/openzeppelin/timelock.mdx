...
OpenZeppelin implementa un contrato inteligente llamado [TimelockController](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/master/contracts/governance/TimelockController.sol) que permite **establecer una demora antes de la ejecución de una tarea**.
...
[TimelockController](https://docs.openzeppelin.com/contracts/4.x/api/governance#TimelockController), a su vez, hereda del contrato [AccessControl](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/master/contracts/access/AccessControl.sol) para que el mismo sea administrado por diferentes roles de usuarios.
