...
[OpenZeppelin nos ofrece dos utilidades](https://github.com/OpenZeppelin/openzeppelin-contracts/tree/master/contracts/utils/structs "OpenZeppelin nos ofrece dos utilidades") para **extender el funcionamiento de los Array y de los Mappings**.
...
Estos son [EnumerableSet.sol](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/master/contracts/utils/structs/EnumerableSet.sol "EnumerableSet.sol") y [EnumerableMap.sol](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/master/contracts/utils/structs/EnumerableMap.sol "EnumerableMap.sol"), tanto para Arrays como para Mappings respectivamente.
