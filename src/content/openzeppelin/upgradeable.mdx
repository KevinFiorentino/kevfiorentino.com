...
Todos los contratos que conoces de OpenZeppelin se encuentran replicados en un nuevo repositorio llamado [openzeppelin-contracts-upgradeable](https://github.com/OpenZeppelin/openzeppelin-contracts-upgradeable) donde se le agrega el sufijo **Upgradeable** a cada uno de ellos.

Es así como encontrarás el contrato [ERC721.sol](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/master/contracts/token/ERC721/ERC721.sol) y el [ERC721Upgradeable.sol](https://github.com/OpenZeppelin/openzeppelin-contracts-upgradeable/blob/master/contracts/token/ERC721/ERC721Upgradeable.sol) en el otro repositorio.
...
> **TIP:** Tanto los entornos de desarrollo de contratos inteligentes de [Hardhat como Truffle ofrecen pluggins](https://docs.openzeppelin.com/upgrades-plugins/) para realizar estas tareas de actualización de forma más sencilla.
