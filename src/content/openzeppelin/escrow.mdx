...
El término [Escrow](https://docs.openzeppelin.com/contracts/2.x/api/payment#Escrow "OpenZeppelin Escrow") seguramente es poco conocido. En pocas palabras, se trata de un **intermediario entre dos partes para la transferencia de un bien o valor de forma segura**.
...
Importante mencionar que `Escrow.sol` hereda de [Ownable.sol](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/master/contracts/access/Ownable.sol "Ownable.sol"). Por lo tanto, el mismo tendrá un dueño. Aunque siempre puedes desarrollar tu propio contrato con su propia lógica si no deseas que el mismo tenga un owner y este sea diferente.
