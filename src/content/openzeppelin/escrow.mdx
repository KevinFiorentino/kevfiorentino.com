---
title: 'OpenZeppelin: Escrow'
description: 'Sin duda, uno de los casos de uso más frecuentes en un contrato inteligente es el denominado como “Escrow”, realizar transferencias entre dos partes de manera segura.'
image: '/tech/openzeppelin.png'
pubDate: '07/01/2023'
englishMetadata: {
  title: 'OpenZeppelin: Escrow',
  description: 'Without a doubt, one of the most frequent use cases in a smart contract is what is known as “Escrow”, making transfers between two parties securely.'
}
prev: 'math'
next: 'upgradeable'
---
...
El término [Escrow](https://docs.openzeppelin.com/contracts/2.x/api/payment#Escrow) seguramente es poco conocido. En pocas palabras, se trata de un **intermediario entre dos partes para la transferencia de un bien o valor de forma segura**.
...
Importante mencionar que `Escrow.sol` hereda de [Ownable.sol](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/master/contracts/access/Ownable.sol). Por lo tanto, el mismo tendrá un dueño. Aunque siempre puedes desarrollar tu propio contrato con su propia lógica si no deseas que el mismo tenga un owner y este sea diferente.
