...
OpenZeppelin [implementa una serie de contratos ERC165](https://github.com/OpenZeppelin/openzeppelin-contracts/tree/master/contracts/utils/introspection) para detectar interfaces en otros contratos.
...
> Nota: Otro estándar interesante para la validación de interfaces es el [ERC1820](https://eips.ethereum.org/EIPS/eip-1820). El mismo es una extensión de ERC165 que permite la declaración y validación de interfaces en direcciones que no necesariamente contengan un contrato.
...
Te animo a que despliegues los contratos anteriores en entornos como [Remix](https://remix.ethereum.org/) y compruebes que el contrato **MyTokenERC20** implementa tanto la interfaz IERC20 como IERC165, pero no la interfaz IERC721. Esto puedes corroborarlo gracias a las funciones del contrato **VerifyInterfaces** que hace las comprobaciones a cada interfaz.
