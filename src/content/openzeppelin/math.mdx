...
Si te encuentras realizando mantenimiento a contratos inteligentes desarrollados hace algunos años, es posible que te encuentres con librerías como [SafeMath](https://github.com/OpenZeppelin/openzeppelin-contracts/tree/master/contracts/utils/math "SafeMath") de OpenZeppelin para resolver estos problemas.
...
> **Nota:** Cuando trabajes con hashes en Solidity, tal vez te llame la atención la palabra [Keccak](https://www.cyberseguridad.net/keccak-es-el-algoritmo-elegido-como-sha-3 "Keccak"). Keccak se trata de un poderoso algoritmo de encriptación asimétrico. Ideal para encriptar contraseñas o realizar validaciones de datos.
