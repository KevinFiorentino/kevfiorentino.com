...
El funcionamiento de toda la red de Bitcoin es grande y complejo de resumir. Siempre es aconsejable leer el [libro blanco de Bitcoin](https://bitcoin.org/files/bitcoin-paper/bitcoin_es.pdf "Libro blanco de Bitcoin") si es de tu interés técnico comprender más en profundidad su funcionamiento técnico.
