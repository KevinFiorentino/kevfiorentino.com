...
Tu contrato hereda de [Ownable](https://external.ink?to=https://github.com/OpenZeppelin/openzeppelin-contracts/blob/master/contracts/access/Ownable.sol) para disponer del modificador `onlyOwner`. De esta forma, **aseguras tu contrato a no cometer ningún error** con respecto a la manipulación de su dueño.
...
Importa y hereda [AccessControl](https://external.ink?to=https://github.com/OpenZeppelin/openzeppelin-contracts/blob/master/contracts/access/AccessControl.sol) desde OpenZeppelin para comenzar a definir tus propios roles.
