...
El estándar [ERC1155](https://external.ink?to=https://ethereum.org/es/developers/docs/standards/tokens/erc-1155/), propuesto en el [EIP1155](https://external.ink?to=https://eips.ethereum.org/EIPS/eip-1155), define que un contrato inteligente puede tener **múltiples tokens a la vez**. Los mismos conviven en el mismo contrato y pueden actuar como tokens fungibles o no-fungibles según nuestra necesidad.
