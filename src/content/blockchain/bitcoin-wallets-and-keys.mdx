...
Los dos tipos son compatibles, tanto la llave pública comprimida como sin comprimir. Los algoritmos de curva elíptica [Secp256k1](https://external.ink?to=https://es.bitcoin.it/wiki/Secp256k1) por detrás permiten esta compatibilidad. Claramente, la llave comprimida es mucho más amigable para el usuario y más utilizada en wallets.
