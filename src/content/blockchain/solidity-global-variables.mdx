...
prev: 'solidity-good-practices'
next: 'solidity-storage'
---
...
Si una **acción crítica** de nuestro contrato depende de un valor aleatorio, debemos buscar alternativas off-chain como [Chainlink](https://external.ink?to=https://docs.chain.link/). Este tipo de servicio se los conoce con el nombre de `Oráculos` para realizar procesamientos no deterministas fuera de la blockchain y reinsertar ese valor en el contrato cobrando una comisión.
