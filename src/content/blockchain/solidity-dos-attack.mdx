...
prev: 'solidity-external-calls'
next: 'solidity-dos-gas'
---
...
> **NOTA:** El ejemplo de esta vulnerabilidad fue tomado y adaptado originalmente de [Solidity by examples](https://external.ink?to=https://solidity-by-example.org/hacks/denial-of-service/).
