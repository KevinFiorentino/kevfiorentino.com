...
El estándar para la creación de tokens es denominado [ERC20](https://external.ink?to=https://ethereum.org/es/developers/docs/standards/tokens/erc-20/), proveniente de la propuesta [EIP20](https://eips.ethereum.org/EIPS/eip-20). La misma estandarizó una interfaz y características de cómo deben ser los tokens que viven en la Blockchain de Ethereum.
...
OpenZeppelin ofrece una [implementación del estandar ERC20](https://external.ink?to=https://github.com/OpenZeppelin/openzeppelin-contracts/blob/master/contracts/token/ERC20/ERC20.sol) auditada y segura que podemos utilizar para crear nuestros propios tokens.
