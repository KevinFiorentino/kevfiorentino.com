...
Uno de los clientes de Bitcoin más populares es **Bitcoin Core**. No deja de ser un [repositorio en GitHub](https://external.ink?to=https://github.com/bitcoin/bitcoin) que deriva del código fuente original que Satoshi Nakamoto entregó a mediados del 2011 para que la comunidad de desarrolladores continuaran con el proyecto.
...
Las propuestas son analizadas por la comunidad por detrás de Bitcoin para su refinamiento, aceptación o rechazo. Cualquier persona en el mundo puede [elaborar un BIP](https://external.ink?to=https://github.com/bitcoin/bips) y el mismo será evaluado por la comunidad.

Bitcoin no es la única tecnología que implementa este tipo de procesos para la evaluación de propuestas y mejoras de un software OpenSource. Tal vez conozcas los [EIP](https://external.ink?to=https://ethereum.org/es/eips/) (Ethereum Improvement Proposal) que, si bien puede diferir en el proceso, tiene el mismo objetivo. Si salimos del mundo Blockchain, podemos encontrar el [TC39](https://tc39.es/) para las propuestas de mejora de Javascript.
