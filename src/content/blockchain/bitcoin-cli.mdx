...
Existen realmente muchos comandos que conocerás poco a poco. El Profesor Marulanda se ha tomado el trabajo de dejarnos una interesante [guía con los comandos más importantes](https://external.ink?to=https://github.com/js-ms/platzi-bitcoin-core/blob/main/bitcoin-cli.md) y es un buen punto para comenzar a interactuar con la Blockchain de Bitcoin.
