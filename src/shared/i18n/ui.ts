...
export const ui = {
  en: {
    ...
    '2025': `
      ...
      <p>In the second half of this year, I needed a change, both personally and professionally and that is when I started working for Accenture. After years of working as a freelancer, a contractor and an entrepreneur, I was ready for a meaningful shift and the opportunity to be part of an international corporation. This is merely the start of a new chapter in my professional development, where I aim to apply my skills, expand my knowledge and contribute meaningfully to future projects.</p>
    `,
    '2026': `
      <p>This professional year is all about Accenture, working as a software architect for an internal project. I have the opportunity of working for a big and international team, with people from the USA and India, which gives me the possibility of practicing my English that is continuously evolving.</p>
      <p>My tasks are focused on maintaining Angular apps and also working with an automation team with Playwright and creating pipelines on Azure DevOps. I found a very close place to the artificial intelligence, becoming a reference in our team from my previous knowledge, developing AI solutions, and creating workshops for training people in technologies such as Copilot, MCP, and Claude Code, among others. Besides personal investigations, creating a project called UsefulsHub (see above), and never stopping learning about technologies with Platzi.</p>
      <p>On the other hand, there's a part of me that needs to return to blockchain, technologically and economically speaking. I think throughout this year I will create some dapps with the help of AI.</p>
    `,
    'all': `
      ...
      <p>Overall, my career has gone through five stages: PHP developer, JavaScript developer, blockchain researcher, CTO of a startup, and since June 2025, I have entered a completely new stage, working at Accenture as a software architect.</p>
  ...
  es: {
    ...
    '2025': `
      ...
      <p>En el segundo semestre de este año, necesitaba un cambio, tanto personal como profesional, y fue entonces cuando empecé a trabajar para Accenture. Tras años trabajando como freelance, contractor y emprendedor, estaba listo para un cambio significativo y la oportunidad de formar parte de una corporación internacional. Este es solo el comienzo de una nueva etapa en mi desarrollo profesional, donde aspiro a aplicar mis habilidades, ampliar mis conocimientos y contribuir significativamente a proyectos futuros.</p>
    `,
    '2026': `
      <p>Este año profesional es todo Accenture, trabajando como arquitecto de software para un proyecto interno. Tengo la oportunidad de trabajar para un equipo numeroso e internacional, con gente de USA e India, lo que me da la posibilidad de practicar mi inglés, que sigue evolucionando.</p>
      <p>Mis tareas están enfocadas en mantenimiento de aplicaciones con Angular, y también trabajando con un equipo de automation con Playwright y creando pipelines en Azure DevOps. Logré encontrar un lugar muy de cerca con la inteligencia artificial, volviéndome referente en nuestro equipo a partir de mi conocimiento previo, desarrollado soluciones IA y creando workshops para capacitar a las personas en tecnologías como Copilot, MCP, Claude Code, entre otras. Además de investigaciones personales, creando un proyecto llamado UsefulsHub (ver más arriba), y nunca dejando de aprender sobre tecnología con Platzi.</p>
      <p>Por otro lado, hay una parte de mí que necesita volver a blockchain, tecnológicamente y económicamente hablando. Creo que a lo largo de este año voy a estar creando algunas dapps con ayuda también de la IA.</p>
    `,
    'all': `
      ...
      <p>En general, mi carrera ha pasado por cinco etapas: desarrollador PHP, desarrollador JavaScript, investigador de blockchain, CTO de una startup y desde junio de 2025, he entrado en una etapa completamente nueva trabajando en Accenture como arquitecto de software.</p>
